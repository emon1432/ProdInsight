@extends('layouts.app')
@section('title', __('Create New Brand'))
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">{{ __('Create New Brand') }}</h5>
                ...
                <div class="card-body">
                    <form class="row g-6 common-form" action="{{ route('brands.store') }}" method="POST"
                        ...
                        <div class="col-md-6 form-control-validation">
                            ...
                            <input type="text" name="code" id="code" class="form-control"
                                placeholder="{{ __('Enter code') }}" required value="{{ next_code_generator(App\Models\Brand::class, 'code', 'BR-') }}" />
                        </div>
                        <div class="col-md-6 form-control-validation">
                        ...
                        <div class="col-12 form-control-validation">
                            <x-form-action-button :resource="'brands'" :action="'create'" :type="'page'" />
                        </div>
                    </form>
                </div>
            </div>
