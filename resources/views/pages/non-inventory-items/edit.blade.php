<div class="modal fade" id="edit-non-inventory-items-modal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
    data-bs-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('Edit Non Inventory Item') }}</h5>
            ...
            <form class="row g-6 common-form" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <x-form-action-button :resource="'non-inventory-items'" :action="'edit'" :type="'modal'" />
                </div>
            </form>
        </div>
    </div>
