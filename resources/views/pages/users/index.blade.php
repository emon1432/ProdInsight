...
@push('scripts')
    <script>
        document.addEventListener("DOMContentLoaded", function(e) {
            var n, t = document.querySelector(".datatables-basic");
            let l;
            t && ((s = document.createElement("h5")).classList.add("card-title", "mb-0", "text-md-start",
                    "text-center", "pb-md-0", "pb-6"), s.innerHTML = "DataTable with Buttons", l =
                new DataTable(t, {
                    ...
                    columnDefs: [{
                        ...
                        render: function(e, t, a, s) {
                            ...
                            if (r) l =
                                ...
                                r = ["success", "danger", "warning", "info", "dark", "primary",
                                    "secondary"
                                ][Math.floor(6 * Math.random())];
                                let e = n.match(/\b\w/g) || [];
                                e = ((e.shift() || "") + (e.pop() || "")).toUpperCase(), l =
                                    `<span class="avatar-initial rounded-circle bg-label-${r}">${e}</span>`
                            }
                            return `
                                    ...
                                    buttons: [{
                                        ...
                                        customize: function(e) {
                                            e.document.body.style.color = config
                                                .colors.headingColor, e.document
                                                .body.style.borderColor = config
                                                .colors.borderColor, e.document
                                                .body.style.backgroundColor =
                                                config.colors.bodyBg;
                                            e = e.document.body.querySelector(
                                                "table");
                                            e.classList.add("compact"), e.style
                                                .color = "inherit", e.style
                                                .borderColor = "inherit", e
                    ...
                    responsive: {
                        details: {
                            ...
                            renderer: function(e, t, a) {
                                var s, r, n, a = a.map(function(e) {
                                    return "" !== e.title ? `<tr data-dt-row="${e.rowIndex}" data-dt-column="${e.columnIndex}">
                      <td>${e.title}:</td>
                      <td>${e.data}</td>
                    </tr>` : ""
                                }).join("");
                                return !!a && ((s = document.createElement("div")).classList.add(
                                        "table-responsive"), r = document.createElement("table"), s
                                    .appendChild(r), r.classList.add("table"), r.classList.add(
                                        "datatables-basic"), (n = document.createElement("tbody"))
                                    .innerHTML = a, r.appendChild(n), s)
                            }
                        }
                    }
                }), document.addEventListener("click", function(e) {
                    e.target.classList.contains("delete-record") && (l.row(e.target.closest("tr")).remove()
                        .draw(), e = document.querySelector(".dtr-bs-modal")) && e.classList.contains(
                        "show") && bootstrap.Modal.getInstance(e)?.hide()
                }));
            ...
            `
                ...
                e.target.classList.contains("delete-record") && (a.row(e.target.closest("tr")).remove()
                    .draw(), e = document.querySelector(".dtr-bs-modal")) && e.classList.contains(
                    "show") && bootstrap.Modal.getInstance(e)?.hide()
            }));
            ...
            `
                ...
                drawCallback: function(e) {
                    ...
                    t.column(2, {
                        ...
                        var a, s;
                        n !== e && ((a = document.createElement("tr")).classList.add(
                                "group"), (s = document.createElement("td"))
                            .setAttribute("colspan", "8"), s.textContent = e, a
                            .appendChild(s), r[t].parentNode.insertBefore(a, r[t]), n =
                            e)
                    })
                },
                responsive: {
                    details: {
                      ...
                      <td>${e.data}</td>
                            ...
                            return !!a && ((s = document.createElement("div")).classList.add(
                                    "table-responsive"), r = document.createElement("table"), s
                                .appendChild(r), r.classList.add("table"), (n = document
                                    .createElement("tbody")).innerHTML = a, r.appendChild(n), s)
                        }
                    }
                }
            }), document.addEventListener("click", function(e) {
                e.target.classList.contains("delete-record") && (r.row(e.target.closest("tr")).remove()
                    .draw(), e = document.querySelector(".dtr-bs-modal")) && e.classList.contains(
                    "show") && bootstrap.Modal.getInstance(e)?.hide()
            }));
            ...
            `
                ...
                e.target.classList.contains("delete-record") && (o.row(e.target.closest("tr")).remove()
                    .draw(), e = document.querySelector(".dtr-bs-modal")) && e.classList.contains(
                    "show") && bootstrap.Modal.getInstance(e)?.hide()
            })), setTimeout(() => {
                [{
                    ...
                    document.querySelectorAll(e).forEach(t => {
                        a && a.split(" ").forEach(e => t.classList.remove(e)), s && s.split(
