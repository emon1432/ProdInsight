<div class="modal fade" id="add-units-modal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="row g-6 common-form" action="{{ route('units.store') }}" method="POST"
