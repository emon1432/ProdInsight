<div class="modal fade" id="edit-production-stages-modal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
    data-bs-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('Edit Production Stage') }}</h5>
            ...
            <form class="row g-6 common-form" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <x-form-action-button :resource="'production-stages'" :action="'edit'" :type="'modal'" />
                </div>
            </form>
        </div>
    </div>
