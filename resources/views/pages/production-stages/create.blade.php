<div class="modal fade" id="add-production-stages-modal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
    data-bs-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('Add Production Stage') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"
                    aria-label="{{ __('Close') }}"></button>
            </div>
            <form class="row g-6 common-form" action="{{ route('production-stages.store') }}" method="POST"
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12 form-control-validation mb-5">
                        ...
                        <input type="text" name="code" class="form-control" placeholder="{{ __('Enter code') }}"
                            required value="{{ next_code_generator(App\Models\ProductionStage::class, 'code', 'PS-') }}" />
                    </div>
                    <div class="col-md-12 form-control-validation mb-5">
                ...
                <div class="modal-footer">
                    <x-form-action-button :resource="'production-stages'" :action="'create'" :type="'modal'" />
                </div>
            </form>
        </div>
    </div>
