<div class="modal fade" id="add-taxes-modal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="row g-6 common-form" action="{{ route('taxes.store') }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-control-validation mb-5">
                            ...
                            <input type="number" name="rate" class="form-control" step="0.01" min="0"
                                placeholder="{{ __('Enter rate value') }}" required />
                        </div>
                ...
                <div class="modal-footer">
                    <x-form-action-button :resource="'taxes'" :action="'create'" :type="'modal'" />
                </div>
            </form>
        </div>
    </div>
